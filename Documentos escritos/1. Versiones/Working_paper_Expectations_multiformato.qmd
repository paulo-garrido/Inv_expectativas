...
format:
  ...
  docx:
    reference-doc: "reference-word-working-paper.docx"
    toc: false
    number-sections: true
    number-depth: 2
...
\centering
\vspace*{-1.50cm}
{\small \textit{Programa de Estudios Superiores en Banca Central}\\
...
::: {custom-style="Academic Affiliation"}
*Programa de Estudios Superiores en Banca Central*\
*Maestría en Economía y Finanzas Aplicadas*
:::

::: {custom-style="Abstract"}
**Resumen.** El estudio analiza la evolución del anclaje de las expectativas de inflación a 24 meses en Guatemala durante 2010--2026 como una aproximación a la credibilidad de la política monetaria. Más que identificar únicamente su proximidad respecto de la meta, el análisis distingue dos dimensiones complementarias: la sensibilidad de las expectativas frente a la inflación observada y la referencia nominal hacia la cual parecen converger. La estrategia empírica combina regresiones móviles con un modelo VAR bivariado de parámetros variantes en el tiempo estimado mediante filtro de Kalman. Los resultados muestran una reducción gradual de la sensibilidad de las expectativas y un aumento de la proxy de credibilidad, desde valores cercanos a 0.75 al inicio de la muestra hasta aproximadamente 0.88 al final. Paralelamente, el ancla inflacionaria implícita, inicialmente situada por encima de la meta oficial, converge progresivamente hacia niveles próximos al objetivo inflacionario. Esta configuración adquiere particular relevancia durante el episodio inflacionario de 2021--2023: pese al fuerte aumento de la inflación observada, las expectativas a 24 meses y el ancla implícita registraron movimientos considerablemente más contenidos. En conjunto, la evidencia es consistente con un fortalecimiento gradual del anclaje y de la credibilidad monetaria en Guatemala.
:::
...
\vspace{0.1cm}
\includegraphics[width=0.80\textwidth]{\detokenize{../Data y resultados/figuras y tablas/figuras/fig_contexto_inflacion_historica_emei.png}}
\vspace{0.1cm}
...
::: {.content-visible when-format="docx"}
![Evolución histórica de la inflación en Guatemala, 1997--2026](../Data%20y%20resultados/figuras%20y%20tablas/figuras/fig_contexto_inflacion_historica_emei.png){#fig-inflacion-historica width="88%" fig-align="center"}

::: {custom-style="Figure Note"}
...
$$\widetilde e^{24}_t=e^{24}_t-\pi_t^m$$
...
$$ \widetilde{e}^{24}_t = e^{24}_t-\pi^m_t, \qquad \widetilde{\pi}_t = \pi_t-\pi^m_t, $$
...
$$ \mathcal{W}_t = \\{t-W+1,\ldots,t\\}. $$

Dentro de cada ventana se estima la siguiente especificación:

$$ \widetilde{e}^{24}_{\tau} = \alpha_t + \rho_t\widetilde{e}^{24}_{\tau-1} + \beta_t\widetilde{\pi}_{\tau-1} + u_{\tau}, \qquad \tau\in\mathcal{W}_t. $$ {#eq-modelo-rolling}
...
$$ e_t^{24} = c_{0t} + c_t\pi_{t-1} + d e_{t-1}^{24} + \varepsilon_{e,t}. $$
...
$$ e_t^{24} = e_{t-1}^{24} = \bar e_t^{24}, $$ y $$ \pi_t = \pi_{t-1} = \bar\pi_t. $$ Bajo estas condiciones, la ecuación de expectativas se transforma en:

$$ \bar e_t^{24} = c_{0t} + c_t\bar\pi_t + d\bar e_t^{24}. $$

Trasladando el término asociado con la persistencia de las expectativas al lado izquierdo, se obtiene:

$$ \bar e_t^{24} - d\bar e_t^{24} = c_{0t} + c_t\bar\pi_t, $$

y, al factorizar:

$$ (1-d)\bar e_t^{24} = c_{0t} + c_t\bar\pi_t. $$
...
$$ \bar e_t^{24} = \frac{c_{0t}}{1-d} + \frac{c_t}{1-d}\bar\pi_t. $$ {#eq-equilibrio-expectativas}
...
$$ \bar e_t^{24} = \lambda_t\pi_t^{*} + (1-\lambda_t)\bar\pi_t. $$ {#eq-formacion-anclada-eq}

al comparar los coeficientes de las ecuaciones @eq-equilibrio-expectativas y @eq-formacion-anclada-eq, se tiene:
...
\vspace{0.1cm}
\includegraphics[width=0.80\textwidth]{\detokenize{../Data y resultados/figuras y tablas/figuras/3.fig_expectat_meta.png}}
\vspace{0.1cm}
...
::: {.content-visible when-format="docx"}
![Evolución histórica de las expectativas inflacionarias en Guatemala, 2010--2026](../Data%20y%20resultados/figuras%20y%20tablas/figuras/3.fig_expectat_meta.png){#fig-expectativas-meta width="88%" fig-align="center"}
...
\vspace{0.1cm}
\includegraphics[width=0.80\textwidth]{\detokenize{../Data y resultados/figuras y tablas/figuras/fig_obj1_desviacion_distancia_meta.png}}
\vspace{0.1cm}
...
::: {.content-visible when-format="docx"}
![Desviación y distancia de las expectativas de inflación con respecto a la Meta central en Guatemala, 2010--2026](../Data%20y%20resultados/figuras%20y%20tablas/figuras/fig_obj1_desviacion_distancia_meta.png){#fig-desviacion-distancia width="88%" fig-align="center"}
...
\vspace{0.1cm}
\includegraphics[width=0.87\textwidth]{\detokenize{../Data y resultados/output/rolling_beta_60m.png}}
\vspace{0.1cm}
...
::: {.content-visible when-format="docx"}
![Estimación del grado de respuesta de las expectativas a mediano plazo frente a la brecha de inflación, 2010--2026](../Data%20y%20resultados/output/rolling_beta_60m.png){#fig-rolling-beta width="88%" fig-align="center"}
...
\vspace{0.1cm}
\includegraphics[width=0.87\textwidth]{\detokenize{../Data y resultados/output/rolling_rho_60m.png}}
\vspace{0.1cm}
...
::: {.content-visible when-format="docx"}
![Estimación de la respuesta de las expectativas a mediano plazo frente a la persistencia de sus desviaciones respecto de la meta, 2010--2026](../Data%20y%20resultados/output/rolling_rho_60m.png){#fig-rolling-rho width="88%" fig-align="center"}
...
robustez_medidas <- if (
  file.exists(file.path(ruta_robustez, "02_tabla_comparativa_medidas_inflacion.csv"))
) {
  readr::read_csv(
    file.path(ruta_robustez, "02_tabla_comparativa_medidas_inflacion.csv"),
    show_col_types = FALSE
  )
} else {
  NULL
...
robustez_trayectorias <- if (
  file.exists(file.path(ruta_robustez, "03_robustez_trayectorias_vs_baseline.csv"))
) {
  readr::read_csv(
    file.path(ruta_robustez, "03_robustez_trayectorias_vs_baseline.csv"),
    show_col_types = FALSE
  )
} else {
  NULL
...
\vspace{0.1cm}
\includegraphics[width=0.87\textwidth]{\detokenize{../Data y resultados/resultados_objetivo2_TVP_VAR/figura_02_panel_parametros_tvp.png}}
\vspace{0.1cm}
...
::: {.content-visible when-format="docx"}
![Estimaciones suavizadas de los parámetros variantes de la ecuación de expectativas, 2010--2026](../Data%20y%20resultados/resultados_objetivo2_TVP_VAR/figura_02_panel_parametros_tvp.png){#fig-parametros-tvp width="88%" fig-align="center"}
...
\vspace{0.1cm}
\includegraphics[width=0.80\textwidth]{\detokenize{../Data y resultados/resultados_objetivo2_TVP_VAR/figura_03_lambda_t.png}}
\vspace{0.1cm}
...
::: {.content-visible when-format="docx"}
![Trayectoria de proxy de credibilidad, 2010--2026](../Data%20y%20resultados/resultados_objetivo2_TVP_VAR/figura_03_lambda_t.png){#fig-lambda width="88%" fig-align="center"}
...
\vspace{0.1cm}
\includegraphics[width=0.87\textwidth]{\detokenize{../Data y resultados/resultados_objetivo2_TVP_VAR/figura_04_ancla_implicita.png}}
\vspace{0.1cm}
...
::: {.content-visible when-format="docx"}
![Trayectoria del ancla implícita y su relación con la meta de inflación del Banco de Guatemala, 2010--2026](../Data%20y%20resultados/resultados_objetivo2_TVP_VAR/figura_04_ancla_implicita.png){#fig-ancla-implicita width="88%" fig-align="center"}
...
\vspace{0.1cm}
\includegraphics[width=0.87\textwidth]{\detokenize{../Data y resultados/resultados_objetivo2_TVP_VAR/figura_05_dinamica_conjunta_ancla_credibilidad.png}}
\vspace{0.1cm}
...
::: {.content-visible when-format="docx"}
![Inflación, ancla implícita y credibilidad: una lectura conjunta, 2010--2026](../Data%20y%20resultados/resultados_objetivo2_TVP_VAR/figura_05_dinamica_conjunta_ancla_credibilidad.png){#fig-dinamica-conjunta width="88%" fig-align="center"}
