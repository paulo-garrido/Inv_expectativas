...
En particular, se examinan dos aspectos: si la reducción de la sensibilidad se mantiene cuando las variables se expresan en primeras diferencias; si la autocorrelación residual identificada en la ecuación auxiliar de inflación afecta las trayectorias de $\lambda_t$ y $\pi_t^*$.
